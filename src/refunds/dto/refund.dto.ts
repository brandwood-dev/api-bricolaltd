...
export class CreateRefundDto {
  ...
  @IsString()
  @Length(0, 500, {
    message: 'Reason details must be less than 500 characters',
  })
...
export class ProcessRefundDto {
  @ApiProperty({
    description: 'Refund ID to process',
    example: '123e4567-e89b-12d3-a456-426614174000',
  })
  @IsUUID()
  refundId: string;
  ...
  @ApiProperty({
    description: 'Amount to refund (must match original request)',
    example: 50.0,
  })
  @IsNumber({ maxDecimalPlaces: 2 })
  @Min(0.01, { message: 'Refund amount must be at least £0.01' })
...
export class RefundResponseDto {
  ...
  @ApiProperty({ description: 'Original transaction amount', example: 100.0 })
  ...
  @ApiProperty({
    description: 'Processed by admin user ID',
    example: '123e4567-e89b-12d3-a456-426614174000',
    required: false,
  })
  processedBy?: string;
...
export class RefundStatsDto {
  ...
  @ApiProperty({ description: 'Total refund amount', example: 5000.0 })
  ...
  @ApiProperty({ description: 'Amount refunded this month', example: 1250.0 })
...
export class BulkRefundDto {
  ...
  @ApiProperty({
    ...
    example: 'Bulk refund for service issues',
    required: false,
  })
  @IsOptional()
  @IsString()
