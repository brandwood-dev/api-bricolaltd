...
export class SecurityLog {
  ...
  @ApiProperty({
    description: 'The IP address from which the event occurred',
    required: false,
  })
  ...
  @ApiProperty({
    description: 'The resource or endpoint accessed',
    required: false,
  })
  ...
  @ApiProperty({
    description: 'Whether the security incident has been resolved',
  })
  isResolved: boolean;

  @Column({ name: 'resolved_by', type: 'varchar', length: 36, nullable: true })
  @ApiProperty({
    description: 'ID of the admin who resolved the incident',
    required: false,
  })
